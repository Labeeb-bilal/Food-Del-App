...
const transporter = nodemailer.createTransport({
    ...
    secure: false,
    auth : {
      user : 'labeebbilal0@gmail.com',
      pass : 'eyqjmbtqwqplqpnd',
    }
})
...
//    const pdfPath = path.join(__dirname, `invoice_${order._id}.pdf`);


       try {
        await transporter.sendMail({
          from: '"Food-Del" <labeebbilal0@gmail.com>',
          to,
          subject: 'Your Food-Del Invoice 🍽️',
          html,
        //   attachments: [
        //     {
